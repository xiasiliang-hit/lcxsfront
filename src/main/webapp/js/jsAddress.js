...
var addBankList=function(bankList){
	var bankList = document.getElementById(bankList);
	for(var j=0;j<bankListt.length;j++){
		var option = document.createElement("OPTION");  
        bankList.options.add(option);  
        option.innerText = bankListt[j].name;  
        option.value = bankListt[j].name;  
	}
}
var bankListt=[
{name:'工商银行'},
